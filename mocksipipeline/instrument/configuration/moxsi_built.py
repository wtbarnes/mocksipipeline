"""
Configuration for MOXSI as built
"""
...
__all__ = [
    'moxsi_built',
    'moxsi_built_filtergrams',
    'moxsi_built_spectrogram_pinhole',
    'moxsi_built_spectrogram_slot',
]


# Optics
# NOTE: Roll and ruling will be iterated on based on measurements
...
moxsi_built_filtergrams = InstrumentDesign(
    'cdr-filtergrams',
    [filtergram_1, filtergram_2, filtergram_3, filtergram_4]
)
moxsi_built_spectrogram_pinhole = InstrumentDesign('cdr-dispersed-pinhole', spectrograms_pinhole)
moxsi_built_spectrogram_slot = InstrumentDesign('cdr-dispersed-slot', spectrograms_slot)
moxsi_built = moxsi_built_filtergrams + moxsi_built_spectrogram_pinhole + moxsi_built_spectrogram_slot
